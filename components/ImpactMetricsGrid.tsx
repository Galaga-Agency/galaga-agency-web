...
export default function ImpactMetricsGrid({ metrics }: ImpactMetricsGridProps) {
  ...
  return (
    <div className="impact-metrics-section relative p-12 md:p-16 bg-gradient-to-br from-teal/10 to-turquesa/10 rounded-3xl">
      {/* Background decorative element */}
      <div className="impact-metrics-bg absolute inset-0 opacity-5">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="impact-metrics-grid grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 pb-8">
          {metrics.map((metric, index) => (
            <div key={index} className="impact-metric text-center">
