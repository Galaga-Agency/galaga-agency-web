  ...
  return (
    <div className="w-full max-w-lg xl:max-w-xl mx-auto">
      <Link href={`/casos-de-exito/${slug}`} className="block h-full">
        <div
          className={`relative bg-white rounded-2xl md:rounded-3xl shadow-xl ${colors.glow} md:h-[650px] overflow-hidden group-hover:scale-[1.02] group-hover:shadow-2xl transition-all duration-500 border border-white/20 group`}
        >
          ...
          <div className="p-8 md:p-12 h-[200px] md:h-[230px] flex flex-col justify-between bg-gradient-to-b from-white to-gray-50/50">
            ...
            <div className="flex-1">
              <h3
                className={`text-xl md:text-2xl font-black text-${colors.accent} leading-tight pb-3 md:pb-4 group-hover:scale-105 transition-transform duration-300`}
              >
                {t(titleKey)}
              </h3>
