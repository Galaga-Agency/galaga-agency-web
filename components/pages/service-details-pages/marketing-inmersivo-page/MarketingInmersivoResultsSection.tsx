// components/pages/marketing/MarketingInmersivoResultsSection.tsx
"use client";
    ...
    >
      ...
      <div className="container">
        ...
        <div className="text-center pb-16">
          <span
            className={`text-blanco font-semibold tracking-wider uppercase text-sm transition-all duration-1000 ${
              isVisible
          ...
          <h2
            className={`section-title text-blanco pt-4 pb-6 transition-all duration-1000 ${
              isVisible
                ? "opacity-100 translate-y-0"
          ...
          <p
            className={`text-lg md:text-xl text-blanco/70 w-full max-w-full container-tablet transition-all duration-1000 ${
              isVisible
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-12 xl:gap-16">
          ...
          <div className="relative h-132 md:h-96 lg:h-full xl:min-h-[600px]">
            ...
            <div className="block md:hidden xl:block relative h-full">
              <div
                className={`absolute top-0 w-72 h-1/3 z-10 rotate-3 rounded-2xl shadow-2xl border-4 border-white transition-all duration-1200
                left-1/2 -translate-x-1/2 xl:left-auto xl:right-8 xl:translate-x-0
              ...
              <div
                className={`absolute top-1/3 w-72 h-1/3 z-20 -rotate-2 rounded-2xl shadow-2xl border-4 border-white transition-all duration-1200
                left-1/2 -translate-x-1/2 xl:left-1/2 xl:-translate-x-1/2
                ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"}`}
              ...
              <div
                className={`absolute bottom-0 w-72 h-1/3 z-15 rotate-3 rounded-2xl shadow-2xl border-4 border-white transition-all duration-1200
                left-1/2 -translate-x-1/2 xl:left-auto xl:right-8 xl:translate-x-0
                ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"}`}
            ...
            <div className="hidden md:flex lg:flex xl:hidden gap-4 justify-center items-center h-full px-4">
              <div
                className={`flex-1 pb-10 transition-all duration-1000 ${
              ...
              <div
                className={`flex-1 pt-10 transition-all duration-1000 ${
                  isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"
                }`}
                style={{ transitionDelay: "1200ms" }}
              >
