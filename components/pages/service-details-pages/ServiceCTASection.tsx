...
export default function ServiceCTASection({
  ...
  const getAnimationClasses = () => {
    switch (animationVariant) {
      case "zoom":
        return {
          title: isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75",
          subtitle: isVisible
    ...
    >
      <div className="container relative z-10">
        <div className="text-center pb-8 lg:pb-12">
          ...
          <p
            className={`cta-subtitle text-lg lg:text-xl text-negro font-light leading-relaxed px-4 transition-all duration-1000 ${animations.subtitle}`}
        ...
        <div
          className={`cta-card-buttons flex flex-col gap-4 md:flex-row justify-center transition-all duration-1000 ${animations.buttons}`}
        ...
        <div className="text-center pt-16 lg:pt-20">
          <p
            className={`text-negro text-lg font-light pb-4 transition-all duration-1000 ${animations.contact}`}
