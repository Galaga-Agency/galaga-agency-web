...
export default function TechnologyStackSection() {
  ...
  return (
    <section className="technology-stack-section relative overflow-hidden bg-brand-blanco">
      ...
      <div className="section relative z-10">
        <div className="container">
          <div className="text-center pb-6">
            <span className="fade-in-up opacity-0 text-brand-teal font-semibold tracking-wider uppercase text-sm">
              {t("services-page.technologies-section.eyebrow")}
            </span>

            <h2 className="fade-in-up opacity-0 section-title text-brand-azul-profundo pt-4 pb-6">
              {t("services-page.technologies-section.title")}
            </h2>

            <p className="fade-in-up opacity-0 text-lg md:text-xl text-brand-negro/70">
      ...
      <div className="slide-in-up opacity-0 relative overflow-visible flex flex-col items-center">
        {/* First Marquee - Teal */}
      ...
      <div className="py-16 relative z-10">
        <div className="container">
          <div className="fade-in-up opacity-0 text-center">
