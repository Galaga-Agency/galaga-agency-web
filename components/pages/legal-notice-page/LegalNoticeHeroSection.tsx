...
export default function LegalNoticeHeroSection() {
  ...
  return (
    <section className="legal-notice-hero-section relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <CachedImage
          src="/assets/img/legal-pages/aviso-legal.webp"
          alt="Legal Notice Hero Background"
          fill
      ...
      <div className="container relative z-20 w-full py-20">
        <div className="legal-notice-hero-content w-full flex flex-col justify-center items-center min-h-[70vh]">
