...
export default function PrivacyPolicyHeroSection() {
  ...
  return (
    <section className="privacy-policy-hero-section relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background image layer */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: "url('/assets/img/legal-pages/privacy.webp')",
        }}
      />
      ...
      <div className="container relative z-20 w-full py-20">
        <div className="privacy-policy-hero-content w-full flex flex-col justify-center items-center min-h-[70vh]">
          {/* Eyebrow */}
            ...
            <h1 className="hero-title text-blanco leading-[0.9] tracking-tight drop-shadow-2xl px-4 text-center">
              <span className="block pb-2 md:pb-4">
                <span className="hero-word-1 drop-shadow-xl opacity-0">
                  {t("privacy-policy.hero.privacidad")}
                </span>
              </span>
              <span className="block">
                <span className="hero-word-2 drop-shadow-xl opacity-0">
                  {t("privacy-policy.hero.yTransparencia")}
                </span>
              </span>
            </h1>
          </div>
          ...
          <div className="text-center pb-12 md:pb-16 w-full px-4">
            <p className="hero-subtitle text-lg md:text-2xl lg:text-3xl text-blanco leading-relaxed font-light drop-shadow-xl opacity-0">
              {t("privacy-policy.hero.subtitle")}
            </p>
          </div>
        </div>
      </div>
