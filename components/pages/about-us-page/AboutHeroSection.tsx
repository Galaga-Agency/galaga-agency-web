...
import { Puzzle3D } from "@/components/3D/Puzzle3D.tsx";
...
export default function AboutHeroSection() {
  ...
  return (
    <section
      className="about-hero-section relative min-h-screen flex items-center justify-center overflow-hidden bg-azul-profundo"
    ...
    >
      ...
      <div className="absolute bottom-32 right-32 w-40 h-40 bg-teal/40 rounded-full blur-3xl animate-float-slower" />
      ...
      <div className="container relative z-20 w-full py-20">
        <div className="about-hero-content w-full flex flex-col justify-center items-center text-center min-h-[70vh]">
          {/* Eyebrow */}
