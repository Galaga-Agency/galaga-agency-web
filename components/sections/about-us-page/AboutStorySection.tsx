    ...
    <section className="about-story-section section relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="text-center pb-16 md:pb-20">
          ...
          <p className="about-story-subtitle text-lg md:text-xl text-grafito font-light leading-relaxed px-4">
        ...
        <div className="relative">
          ...
          <div className="relative z-10 flex flex-col gap-16 md:gap-20 lg:gap-24">
            ...
            <div className="story-block story-block-1 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center" data-story="1">
              <div className="story-block-content px-4 lg:px-0">
                <div className="story-block-header flex items-center gap-6 pb-8">
                  <div className="story-block-icon w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-teal to-azul-profundo rounded-2xl flex items-center justify-center shadow-xl">
                  ...
                  <div>
                    <span className="story-block-year text-sm font-semibold text-teal uppercase tracking-wider">1985 - 2020</span>
                    <h3 className="story-block-title text-2xl md:text-3xl font-bold text-negro leading-tight">
                      {t("about-page.story.traditional.title")}
                    </h3>
                  </div>
                </div>
                <p className="story-block-description text-base md:text-lg text-grafito leading-relaxed">
            ...
            <div className="story-block story-block-2 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center" data-story="2">
              ...
              <div className="story-block-content px-4 lg:px-0 lg:order-2">
                <div className="story-block-header flex items-center gap-6 pb-8">
                  <div className="story-block-icon w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-mandarina to-naranja-tostado rounded-2xl flex items-center justify-center shadow-xl">
                    <svg className="w-8 h-8 md:w-10 md:h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <div>
                    <span className="story-block-year text-sm font-semibold text-mandarina uppercase tracking-wider">2020</span>
                    <h3 className="story-block-title text-2xl md:text-3xl font-bold text-negro leading-tight">
            ...
            <div className="story-block story-block-3 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center" data-story="3">
              <div className="story-block-content px-4 lg:px-0">
                <div className="story-block-header flex items-center gap-6 pb-8">
                  <div className="story-block-icon w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-violeta to-azul-profundo rounded-2xl flex items-center justify-center shadow-xl">
                    <svg className="w-8 h-8 md:w-10 md:h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div>
                    <span className="story-block-year text-sm font-semibold text-violeta uppercase tracking-wider">{t("about-page.story.today.year")}</span>
                    <h3 className="story-block-title text-2xl md:text-3xl font-bold text-negro leading-tight">
                      {t("about-page.story.today.title")}
                    </h3>
                  </div>
                </div>
                <p className="story-block-description text-base md:text-lg text-grafito leading-relaxed pb-6">
                  {t("about-page.story.today.description")}
                </p>
                
                {/* Key Values */}
                <div className="story-values-grid grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="story-value text-center p-4 bg-white/60 rounded-xl border border-hielo/50">
                    <div className="story-value-text text-lg font-bold text-teal pb-1">{t("about-page.story.values.strategy")}</div>
                  </div>
                  <div className="story-value text-center p-4 bg-white/60 rounded-xl border border-hielo/50">
                    <div className="story-value-text text-lg font-bold text-mandarina pb-1">{t("about-page.story.values.technology")}</div>
                  </div>
                  <div className="story-value text-center p-4 bg-white/60 rounded-xl border border-hielo/50">
                    <div className="story-value-text text-lg font-bold text-violeta pb-1">{t("about-page.story.values.emotion")}</div>
                  </div>
                </div>
              </div>
