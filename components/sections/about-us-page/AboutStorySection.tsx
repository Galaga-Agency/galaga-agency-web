            ...
            <div className="story-block-1 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="story-content-1 px-4 lg:px-0">
                <div className="story-header-1 flex items-center gap-6 pb-8">
                  <div className="story-icon-1 w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-teal to-azul-profundo rounded-full flex items-center justify-center shadow-xl">
                    <Building2 className="w-8 h-8 md:w-10 md:h-10 text-white" />
                  </div>
                  <div>
                    <span className="story-year-1 text-sm font-semibold text-teal uppercase tracking-wider">1985 - 2020</span>
            ...
            <div className="story-block-2 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="story-content-2 px-4 lg:px-0 lg:order-2">
                <div className="story-header-2 flex items-center gap-6 pb-8">
                  <div className="story-icon-2 w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-turquesa to-azul-profundo rounded-full flex items-center justify-center shadow-xl">
                    <Gamepad2 className="w-8 h-8 md:w-10 md:h-10 text-white" />
                  </div>
                  <div>
                    <span className="story-year-2 text-sm font-semibold text-turquesa uppercase tracking-wider">2020</span>
            ...
            <div className="story-block-3 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="story-content-3 px-4 lg:px-0">
                <div className="story-header-3 flex items-center gap-6 pb-8">
                  <div className="story-icon-3 w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-azul-profundo to-teal rounded-full flex items-center justify-center shadow-xl">
                    <Target className="w-8 h-8 md:w-10 md:h-10 text-white" />
                  </div>
                  <div>
                    <span className="story-year-3 text-sm font-semibold text-violeta uppercase tracking-wider">{t("about-page.story.today.year")}</span>
