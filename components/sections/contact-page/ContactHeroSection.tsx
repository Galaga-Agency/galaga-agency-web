...
export default function ContactHeroSection() {
  ...
  return (
    <section className="contact-hero-section relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background image layer */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: "url('/assets/img/contacto/hero.webp')",
        }}
      />
      ...
      <div className="container relative z-20 w-full py-20">
        <div className="contact-hero-content w-full flex flex-col justify-center items-center min-h-[70vh]">
          ...
          <div className="text-center pb-8 md:pb-12 w-full">
            <h1 className="hero-title text-blanco leading-[0.9] tracking-tight drop-shadow-2xl px-4 text-center">
              <span className="block pb-2 md:pb-4">
                <span className="contact-hero-word-1 drop-shadow-xl opacity-0 translate-y-24">
                  {t("contact-page.hero.hablemos")}
                </span>
              </span>
              <span className="block">
                <span className="contact-hero-word-2 drop-shadow-xl opacity-0 translate-y-24">
          ...
          <div className="text-center pb-12 md:pb-16 w-full px-4">
            <p className="contact-hero-subtitle text-lg md:text-2xl lg:text-3xl text-blanco leading-relaxed font-light drop-shadow-xl opacity-0 translate-y-12">
      ...
      <ScrollIndicator className="contact-hero-scroll-indicator absolute bottom-8 left-1/2 opacity-0 z-50 transform -translate-x-1/2" />
    </section>
  );
}