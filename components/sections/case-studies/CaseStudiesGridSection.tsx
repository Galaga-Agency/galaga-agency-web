...
export default function CaseStudiesGridSection() {
  ...
  const caseStudies = [
    {
      ...
      category: "digital",
      categoryKey: "caseStudiesPage.categories.digital",
    ...
    },
    {
      ...
      category: "marketing",
      categoryKey: "caseStudiesPage.categories.marketing",
    ...
    },
    {
      ...
      category: "events",
      categoryKey: "caseStudiesPage.categories.events",
  ...
  const getThemeColors = (color: string) => {
    ...
    return colorMap[color as keyof typeof colorMap] || { main: 'teal', accent: 'turquesa' };
  };
        ...
        <div className="text-center pb-16 md:pb-20">
          <div className="inline-flex items-center gap-3 pb-6">
            ...
            <span className="text-teal font-semibold tracking-wider uppercase text-sm">
              {t("caseStudiesPage.grid.eyebrow")}
            </span>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-64 md:h-80 overflow-hidden">
                  {/* Gradient Overlay */}
                  <div className={`absolute inset-0 bg-gradient-to-br from-${caseStudy.color}/80 to-${caseStudy.accent}/60 z-10 group-hover:opacity-50 transition-all duration-500`}></div>
                  
                  {/* Placeholder for image */}
                  <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                    <div className={`w-20 h-20 bg-${caseStudy.color}/30 rounded-full flex items-center justify-center`}>
                      <svg className={`w-10 h-10 text-${caseStudy.color}`} fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="absolute top-6 left-6 z-20">
                    <div className="bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full border border-white/50 shadow-lg">
                      <span className={`text-sm font-bold text-${caseStudy.color} uppercase tracking-wider`}>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 z-20">
                    <div className="grid grid-cols-3 gap-2">
                      {caseStudy.metrics.slice(0, 3).map((metric, idx) => (
                        <div key={idx} className="bg-black/20 backdrop-blur-sm rounded-lg p-3 text-center">
                ...
                <div className="p-6 md:p-8">
                  <h3 className={`text-xl md:text-2xl font-bold text-${caseStudy.color} pb-4 group-hover:text-negro transition-colors duration-300`}>
                  ...
                  >
                    <span>{t("caseStudiesPage.grid.readMore")}</span>
                ...
                {/* Glow effect */}
                <div className={`absolute inset-0 bg-gradient-to-br from-${caseStudy.color}/10 to-${caseStudy.accent}/5 rounded-2xl md:rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none`}></div>
              </div>
            );
          })}
        </div>
