...
export default function ServicesHeroSection() {
  ...
  return (
    <section className="services-hero-section relative min-h-screen bg-gradient-to-br from-azul-profundo via-teal to-negro flex items-center overflow-hidden">
      ...
      <div className="container relative z-20 w-full py-20">
        <div className="services-hero-content w-full flex flex-col justify-center items-center min-h-[70vh]">
          ...
          <div className="text-center pb-8 md:pb-12 w-full">
            <h1 className="services-hero-title text-4xl md:text-6xl lg:text-8xl font-black text-blanco leading-[0.9] tracking-tight drop-shadow-2xl px-4">
              <span className="block pb-2 md:pb-4">
                <span className="text-turquesa services-hero-word-1">
                  {t("servicesPage.hero.nuestros")}
                </span>
              </span>
              <span className="block">
                <span className="bg-gradient-to-r from-mandarina via-naranja-tostado to-verde-azulado bg-clip-text text-transparent services-hero-word-2">
          ...
          <div className="text-center pb-12 md:pb-16 w-full px-4">
            <p className="services-hero-subtitle text-lg md:text-2xl lg:text-3xl text-hielo leading-relaxed font-light drop-shadow-lg max-w-4xl mx-auto">
          ...
          {/* Scroll indicator */}
          <div className="services-hero-scroll absolute bottom-8 left-1/2 transform -translate-x-1/2 opacity-70">
            <div className="flex flex-col items-center gap-2">
              <span className="text-hielo text-xs uppercase tracking-wider">
                {t("servicesPage.hero.scroll")}
              </span>
